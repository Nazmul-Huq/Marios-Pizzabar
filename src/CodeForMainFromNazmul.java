...
public class CodeForMainFromNazmul {
    static Scanner scanner = new Scanner(System.in);
    public static void main(String[] args) {


        createAndAddNewOrder(); // create a new order and add it to both permanentOrderRecord and orderRecord
        printOrderListForMario(); // print a pizza making list for Mario, only show the order he has to make
    }
    ...
    public static void createAndAddNewOrder(){
        ...
        ArrayList<String> pizzaNames = new ArrayList<>(); // start arrray list for pizza names
